export const KR = {
    ...
    AlSemiconductorDesc: "주조공장이 구리 대신 알루미늄을 사용합니다",
    CostSaver: "비용 절약",
    ...
    LogoutDescV2:
        "다른 장치에서 로그인했습니다. 이 장치는 로그 아웃되었습니다. 다시 로그인 할 수 있지만 다른 장치는 로그 아웃됩니다.",
    LogBackIn: "다시 로그인",
    ...
    ResourceMovementViewport: "정보 제시창 내",
    ...
    AchievementSanJose100: "벤처사업 애호가",
    AchievementSanJose100Desc: "산호세에서 한 번에 100 스위스 돈 벌기",
    AchievementSanJose500: "벤처사업 마니아",
    AchievementSanJose500Desc: "산호세에서 한 번에 500 스위스 돈 벌기",
    AchievementSanJose1000: "벤처사업 자본가",
    AchievementSanJose1000Desc: "산호세에서 한 번에 1000 스위스 돈 벌기",
    AchievementCrowdfundingTycoon: "크라우드펀딩 타이쿤",
    AchievementCrowdfundingTycoonDesc: "단일 크라우드 펀딩으로 1Qa 가치의 리소스 제공하기",
    AchievementCashIsKing: "돈이 곧 권력",
    AchievementCashIsKingDesc: "한 번에 1Qa 현금 보유하기",
    AchievementPowerTycoon: "전력 타이쿤",
    AchievementPowerTycoonDesc: "한 번의 실행으로 1GW 전력 생성하기",
    ...
    BuildingSourceAuto: "오토 소스",
    BuildingSourceManual: "🔍 매뉴얼 소스",
    BuildingSourceReset: "리셋",
    BuildingSourceSelecting: "지도 탭하기...",
    BuildingSourceSetOverride: "기각",
    ...
    FactoryMiningBanner: "이 건물은 이 타일에서 직접 %{resource}을(를) 채굴하고 있습니다",
    WarehouseSourceWeight: "무게: %{weight}",
    YAxisStartsFromZero: "Y축 시작점 0",
    YAxisStartsFromZeroDesc: "모든 그래프의 Y축은 항상 자동 조정되는 대신 0부터 시작됩니다",
    OwnDLC: "%{number}x 확장 소유",
    GeneralServerSuccessMessage: "요청이 성공적으로 완료되었습니다",
    GeneralServerErrorMessage: "서버 에러: %{error}",
    WarehouseInputRoutes: "입력 경로",
    WarehouseOutputRoutes: "출력 경로",
    InputCapacity: "입력 용량",
    MultipleSources: "다중 소스",
    MultipleSourcesDesc:
        "운영 주기 동안 건물이 여러 소스로부터 잠재적으로 리소스를 전송할 수 있도록 허용합니다",
    Water: "물",
    KansasCity: "캔자스 시티",
    Dam: "수자원 댐",
    ...
    StandbyMode: "대기 모드",
    StandbyModeDesc:
        "게임의 시뮬레이션은 백그라운드에서 계속 실행되지만 그래픽을 렌더링하지는 않습니다. 이는 GPU 사용량을 크게 줄이고 CPU 사용량도 적당히 줄일 수 있습니다",
    StandbyModeOn: "대기 모드 실행중",
    StandbyModeOnDesc: "게임이 백그라운드에서 실행되고 있습니다. 대기 모드를 종료하려면 아무 곳이나 누르십시오",
    PigFarm: "돼지 농장",
    Pork: "돼지 고기",
    ...
    BatchOperationGainDesc:
        "이는 %{number}개의 건물에 적용됩니다. 예상 환불 금액은 $%{gain}입니다. 계속하시겠습니까?",
    BatchOperationResult: "%{success}개의 건물에 대한 배치 작업이 완료되었습니다",
    BatchOperationGainResult: "배치 작업 결과: 성공: %{success}, 실패: %{fail}, 총 획득: $%{gain}",
    ...
    StreamingWatch: "시청",
    StreamingStop: "중지",
    StreamingPlayerDisconnected: "%{player}이(가) 실시간 방송에서 연결이 끊겼습니다",
    StreamingPlayerRejected: "%{player}이(가) 실시간 방송 요청을 거부했습니다",
    StreamingPlayerRequested: "%{player}이(가) 실시간 방송 시청을 요청했습니다. 승인 또는 거부하려면 본사로 이동하십시오",
    StreamingSettings: "스트리밍 설정",
    StreamingAvailableStreams: "Available Streams",
    StreamingAudience: "시청자",
    StreamingStopStream: "이 시청자에 대한 스트리밍 중지",
    StreamingAcceptStream: "승인",
    StreamingRejectStream: "거부",
    StreamingStopStreamDesc: "이 시청자에 대한 스트리밍 중지",
    StreamingConnectionFailed:
        "Failed to establish a peer connection - 네트워크에서 P2P 연결을 지원하지 않을 가능성이 높습니다",
    Pizza: "피자",
    ...
    FontSizeScaling: "글꼴 크기 조정",
    FontSizeScalingDesc: "UI 글꼴 크기 척도를 변경합니다. 일부 UI 요소가 적합하지 않은 것처럼 보일 수 있습니다. REQUIRES RELOAD",
    ...
    DefenseModuleCriticalDamageChance: "치명적 피해 가능성",
    DefenseModuleCriticalDamageChanceShort: "Crit Dmg %",
    DefenseModuleCriticalDamageMultiplier: "치명적 피해 승수",
    DefenseModuleCriticalDamageMultiplierShort: "Crit Dmg x",
    DefenseModuleBaseModule: "기본 모듈",
    DefenseCommand: "국방사령부",
    DefenseCommandDesc: "무기로 피해를 입히고 침입자로부터 기지를 방어합니다",
    PathBlocked:
        "웜홀에서 본사로 가는 모든 경로를 차단하기 때문에 이 타일에 건설할 수 없습니다",
    WaveInProgressBuildRemoveDisabled:
        "웨이브가 진행 중일 때는 경로에 건물을 건설하거나 건물을 판매할 수 없습니다",
    ExportSaveForTransfer: "저장한 파일 전송",
    ...
    AchievementIstanbul100: "레오 1세",
    AchievementIstanbul100Desc: "이스탄불에서 한 번에 100 스위스 달러를 법니다",
    AchievementIstanbul500: "유스티니아누스 대제",
    AchievementIstanbul500Desc: "이스탄불에서 한 번에 500 스위스 달러를 법니다",
    AchievementIstanbul1000: "콘스탄티누스 대황제",
    AchievementIstanbul1000Desc: "이스탄불에서 한 번에 1000 스위스 달러를 법니다",
    AchievementPerth100: "페더멜론",
    AchievementPerth100Desc: "퍼스에서 한 번에 100 스위스 달러를 법니다",
    AchievementPerth500: "왈라비",
    AchievementPerth500Desc: "퍼스에서 한 번에 500 스위스 달러를 법니다",
    AchievementPerth1000: "캥거루",
    AchievementPerth1000Desc: "퍼스에서 한 번에 1000 스위스 달러를 법니다",
    AchievementKansasCity100: "찐 옥수수",
    AchievementKansasCity100Desc: "캔자스시티에서 한 번에 100 스위스 달러를 법니다",
    AchievementKansasCity500: "콘도그",
    AchievementKansasCity500Desc: "캔자스시티에서 한 번에 500 스위스 달러를 법니다",
    AchievementKansasCity1000: "팝콘",
    AchievementKansasCity1000Desc: "캔자스시키에서 한 번에 1000 스위스 달러를 법니다",
    AchievementRioDeJaneiro100: "르블롱",
    AchievementRioDeJaneiro100Desc: "리우데자네이루에서 한 번에 100 스위스 달러를 법니다",
    AchievementRioDeJaneiro500: "바하 다 티주카",
    AchievementRioDeJaneiro500Desc: "리우데자네이루에서 한 번에 500 스위스 달러를 법니다",
    AchievementRioDeJaneiro1000: "코파카바나",
    AchievementRioDeJaneiro1000Desc: "리우데자네이루에서 한 번에 1000 스위스 달러를 법니다",
    AchievementRandomIsland100: "베르누이",
    AchievementRandomIsland100Desc: "랜덤 섬에서 한 번에 100 스위스 달러를 법니다",
    AchievementRandomIsland500: "푸아송",
    AchievementRandomIsland500Desc: "랜덤 섬에서 한 번에 500 스위스 달러를 법니다",
    AchievementRandomIsland1000: "가우스",
    AchievementRandomIsland1000Desc: "랜덤 섬에서 한 번에 1000 스위스 달러를 법니다",
    ...
    IndustryZoneMaxBuildingLevelDesc: "이 산업 영역 내에서 지원되는 최대 건물 레벨",
    IndustryZoneHelp: "산업구역은 어떻게 작용하나요?",
    IndustryZoneProductivityBoost: "산업 지대 플러스",
